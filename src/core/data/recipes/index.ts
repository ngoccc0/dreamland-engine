 ...
 *
 * @remarks
 * Aggregates all crafting recipes from various modular files
 * (e.g., base game recipes, mod-added recipes) into a single, comprehensive
 * `allRecipes` object. This is the canonical source of truth for all recipes.
 *
 * - Base game recipes defined inline
 * - Nature+ mod recipes imported from nature_plus.ts
 * - Future mods can be easily added by importing and spreading here
 */

import type { Recipe } from '@/core/types/definitions/recipe';
import { naturePlusRecipes } from './nature_plus';

/**
 * Master record of all crafting recipes available in the game.
 * Combines base game recipes with modded recipes.
 */
export const allRecipes: Record<string, Recipe> = {
    ...
    'simple_stone_axe_recipe': {
        ...
        ingredients: [
            ...
            { name: 'cobblestone', quantity: 1 },
            { name: 'thorny_vine', quantity: 1 },
        ],
        description: {
            en: 'Craft a basic stone axe. An essential tool for survival.',
            vi: 'Chế tạo một chiếc rìu đá cơ bản. Một công cụ cần thiết để sinh tồn.',
        },
    },
    'weak_health_potion_recipe': {
        ...
        description: {
            en: 'Brew a simple health potion from herbs and clean water.',
            vi: 'Pha chế một lọ thuốc máu đơn giản từ thảo dược và nước sạch.',
        },
    },
    'torch_recipe': {
        ...
        description: {
            en: 'Create a temporary light source to explore dark places.',
            vi: 'Tạo một nguồn sáng tạm thời để khám phá những nơi tối tăm.',
        },
    },
    'inflatable_raft_recipe': {
        ...
        description: {
            en: 'Craft a simple raft to travel across water.',
            vi: 'Chế tạo một chiếc bè đơn giản để đi qua mặt nước.',
        },
    },
    'stone_dagger_recipe': {
        ...
        description: {
            en: 'Craft a stone dagger for self-defense.',
            vi: 'Chế tạo một con dao găm bằng đá để tự vệ.',
        },
    },
    'wooden_shield_recipe': {
        ...
        description: {
            en: 'Craft a wooden shield to block attacks.',
            vi: 'Chế tạo một chiếc khiên gỗ để chặn các cuộc tấn công.',
        },
    },
    'bandage_recipe': {
        ...
        description: {
            en: 'Create a clean bandage to treat wounds.',
            vi: 'Tạo một miếng băng sạch để băng bó vết thương.',
        },
    },
    'stone_pickaxe_recipe': {
        ...
        description: {
            en: 'Craft a stone pickaxe for mining minerals.',
            vi: 'Chế tạo một chiếc cuốc đá để khai thác khoáng sản.',
        },
    },
    'bone_spear_recipe': {
        ...
        description: {
            en: 'Craft a bone spear for hunting and combat.',
            vi: 'Chế tạo một cây giáo xương để săn bắn và chiến đấu.',
        },
    },
    'obsidian_battleaxe_recipe': {
        ...
        description: {
            en: 'Craft a fearsome battleaxe from obsidian.',
            vi: 'Chế tạo một chiếc rìu chiến đáng sợ từ obsidian.',
        },
    },
    'alligator_hide_armor_recipe': {
        ...
        description: {
            en: 'Craft a durable set of alligator hide armor.',
            vi: 'Chế tạo một bộ giáp bền từ da cá sấu.',
        },
    },
    'strong_health_potion_recipe': {
        ...
        description: {
            en: 'Brew a potent healing potion.',
            vi: 'Pha chế một lọ thuốc chữa bệnh mạnh.',
        },
    },
    'harpy_feather_bow_recipe': {
        ...
        description: {
            en: 'Craft a lightweight and precise bow.',
            vi: 'Chế tạo một cây cung nhẹ và chính xác.',
        },
    },
    'golem_core_staff_recipe': {
        ...
        description: {
            en: 'Imbue a staff with the power of a golem core.',
            vi: 'Thấm nhuần một cây trượng với sức mạnh của lõi người đá.',
        },
    },
    'stamina_potion_recipe': {
        ...
        description: {
            en: 'Mix a potion to rapidly restore stamina.',
            vi: 'Pha một lọ thuốc để phục hồi thể lực nhanh chóng.',
        },
    },
    'dwarven_war_hammer_recipe': {
        ...
        description: {
            en: 'Forge a mighty war hammer.',
            vi: 'Rèn một chiếc búa chiến hùng mạnh.',
        },
    },
