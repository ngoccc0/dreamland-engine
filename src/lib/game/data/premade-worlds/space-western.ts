...
const items: GeneratedItem[] = [
    { name: 'Súng lục Laser', description: 'item_laser_revolver_desc', emoji: '🔫', category: 'Weapon', tier: 3, effects: [], baseQuantity: { min: 1, max: 1 }, spawnBiomes: [], equipmentSlot: 'weapon', attributes: { physicalAttack: 8, critChance: 5, magicalAttack: 0, attackSpeed: 0, cooldownReduction: 0 } },
