...
export default function GameLayout(props: GameLayoutProps) {
    ...
    const craftableCount = Object.values(recipes).filter(recipe => {
        const outcome = calculateCraftingOutcome(playerStats.items, recipe, customItemDefinitions);
        return outcome.canCraft;
    }).length;
                    ...
                    <div className="flex flex-col gap-4 flex-grow">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="grid grid-cols-3 sm:grid-cols-5 gap-2">
                                ...
                                <Tooltip><TooltipTrigger asChild><Button variant="outline" className="h-14 w-full" onClick={() => { setCraftingOpen(true); focusCustomActionInput(); }}><Hammer /></Button></TooltipTrigger><TooltipContent><p>{t('craftingTooltip')} ({t('craftableNow', {count: craftableCount})})</p></TooltipContent></Tooltip>
