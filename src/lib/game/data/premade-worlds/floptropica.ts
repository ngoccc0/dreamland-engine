...
import type { GeneratedItem, Structure, Skill, WorldConcept, ItemCategory } from '@/lib/game/types';

const floptropicaItems: GeneratedItem[] = [
    { name: 'Chảo của Jiafei', description: 'item_jiafei_pan_desc', emoji: '🍳', category: 'Weapon', subCategory: 'Tool', tier: 2, effects: [], baseQuantity: { min: 1, max: 1 }, spawnBiomes: ['floptropica'], equipmentSlot: 'weapon', attributes: { physicalAttack: 5, critChance: 2 } },
