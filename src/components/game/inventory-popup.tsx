                      ...
                      <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                          <button onClick={() => { lastOpenedIndex.current = idx; }} className="w-full h-20 flex flex-col items-center justify-center bg-muted rounded-md cursor-pointer hover:bg-accent/20 relative">
                            <IconRenderer icon={pickIcon(definition, item)} size={28} alt={getTranslatedText(item.name, language)} />
                        ...
                        <DropdownMenuContent className="w-64">
                          <DropdownMenuLabel className="font-normal">
                            <p className="font-bold flex items-center gap-2">
                              <IconRenderer icon={pickIcon(definition, item)} size={30} alt={getTranslatedText(item.name, language)} />
