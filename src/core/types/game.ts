...
export interface GameSettings {
    ...
    /** When true, disables automatic time progression when player is idle/backgrounded. Pause gameplay clock. */
    pauseGameIdleProgression?: boolean;
    /** Warning threshold before idle progression (milliseconds). Default 4 * 60_000 (4 min, warning 1min before 5min idle). */
