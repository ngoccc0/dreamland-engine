...
const items: GeneratedItem[] = [
    ...
    { name: 'Nước tẩm Gia vị', description: 'item_spice_infused_water_desc', emoji: '💧', category: 'Support', tier: 2, effects: [{ type: 'RESTORE_STAMINA', amount: 30 }, { type: 'RESTORE_MANA', amount: 5 }], baseQuantity: { min: 1, max: 1 }, spawnBiomes: ['desert'] },
...
const skill2: Skill = { name: 'skillFireballName', description: 'skillFireballDesc', tier: 1, manaCost: 15, effect: { type: 'DAMAGE', amount: 15, target: 'ENEMY' } };
