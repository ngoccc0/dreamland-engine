...
export function useExperienceState(gameState: GameState) {
  ...
  }, [gameState.playerStats.totalExperience, gameState.playerStats.level, gameState.playerStats.hasLeveledUp]);
}
 ...
 */
export function useExperienceIntegration(experienceUsecase: ExperienceUseCase) {
  /**
