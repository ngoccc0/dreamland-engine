...
const items: GeneratedItem[] = [
    ...
    { name: 'Bột Dinh dưỡng', description: 'item_nutrient_paste_desc', emoji: '🧪', category: 'Food', tier: 1, effects: [{ type: 'RESTORE_STAMINA', amount: 20 }, { type: 'RESTORE_MANA', amount: 5 }], baseQuantity: { min: 2, max: 4 }, spawnBiomes: ['space_station'] },
