...
export const materialItems: Record<string, ItemDefinition> = {
    ...
    'pebbles': {
        ...
        tier: 1,
        category: 'Material',
        emoji: { type: 'image', url: '/asset/images/rock.png' },
        effects: [],
        baseQuantity: { min: 1, max: 2 },
        spawnEnabled: true,
    },
    ...
    'bone_fragment': {
        ...
        tier: 1,
        category: 'Material',
        emoji: { type: 'image', url: '/asset/images/bone_shards.png' },
        effects: [],
        baseQuantity: { min: 1, max: 2 },
        spawnEnabled: true,
    },
    ...
    'small_animal_hide': {
        ...
        tier: 1,
        category: 'Material',
        emoji: { type: 'image', url: '/asset/images/hide_dark.png' },
        effects: [],
    ...
    'boar_hide': {
        ...
        tier: 2,
        category: 'Material',
        emoji: { type: 'image', url: '/asset/images/hide_dark_brown.png' },
        effects: [],
        baseQuantity: { min: 1, max: 1 },
        spawnEnabled: false,
    },
    ...
    'wildflower': {
        ...
        tier: 1,
        category: 'Material',
        emoji: { type: 'image', url: '/asset/images/dandelion.png' },
        effects: [],
        baseQuantity: { min: 1, max: 2 },
        spawnEnabled: true,
    },
