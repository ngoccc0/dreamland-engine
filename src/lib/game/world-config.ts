...
export const worldConfig: Record<Terrain, BiomeDefinition> = {
    forest: {
        ...
        allowedNeighbors: ['grassland', 'mountain', 'swamp', 'jungle', 'wall'],
        defaultValueRanges: {
    ...
    grassland: {
        ...
        allowedNeighbors: ['forest', 'desert', 'swamp', 'jungle', 'wall'],
        defaultValueRanges: {
    ...
    desert: {
        ...
        allowedNeighbors: ['grassland', 'mountain', 'volcanic', 'wall'],
        defaultValueRanges: {
    ...
    mountain: {
        ...
        allowedNeighbors: ['forest', 'desert', 'volcanic', 'wall', 'cave'],
        defaultValueRanges: {
    ...
    cave: {
        ...
        allowedNeighbors: ['mountain', 'wall'],
        defaultValueRanges: {
