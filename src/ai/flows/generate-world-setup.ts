...
const generateWorldSetupFlow = ai.defineFlow(
  ...
  async (input) => {
    ...
    const allTerrains: Terrain[] = ["forest", "grassland", "desert", "swamp", "mountain", "cave", "jungle", "volcanic", "tundra", "beach", "mesa", "mushroom_forest", "corrupted_lands", "floating_islands"];
