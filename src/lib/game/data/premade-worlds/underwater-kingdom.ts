...
const items: GeneratedItem[] = [
    { name: { en: 'Bioluminescent Pearl', vi: 'Ngọc trai Phát quang' }, description: { en: 'item_bioluminescent_pearl_desc', vi: 'item_bioluminescent_pearl_desc' }, emoji: '💡', category: 'Material', tier: 2, effects: [], baseQuantity: { min: 1, max: 3 }, spawnBiomes: ['underwater', 'ocean'], spawnEnabled: false },
    { name: { en: 'Coral Spear', vi: 'Giáo San hô' }, description: { en: 'item_coral_spear_desc', vi: 'item_coral_spear_desc' }, emoji: '🔱', category: 'Weapon', tier: 2, effects: [], baseQuantity: { min: 1, max: 1 }, spawnBiomes: [], equipmentSlot: 'weapon', attributes: { physicalAttack: 5 }, spawnEnabled: false },
    { name: { en: 'Algae Salve', vi: 'Thuốc mỡ Tảo biển' }, description: { en: 'item_algae_salve_desc', vi: 'item_algae_salve_desc' }, emoji: '🌿', category: 'Support', tier: 1, effects: [{ type: 'HEAL', amount: 20 }, { type: 'RESTORE_MANA', amount: 2 }], baseQuantity: { min: 1, max: 2 }, spawnBiomes: ['underwater'], spawnEnabled: false },
    { name: { en: 'Ancient Tablet Fragment', vi: 'Mảnh Bia đá Cổ' }, description: { en: 'item_ancient_tablet_fragment_desc', vi: 'item_ancient_tablet_fragment_desc' }, emoji: '📜', category: 'Data', tier: 3, effects: [], baseQuantity: { min: 1, max: 1 }, spawnBiomes: ['underwater'], spawnEnabled: false },
];
