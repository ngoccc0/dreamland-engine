// ai/tools/game-actions-impl.ts
/**
 * Actual implementation of game action tools.
 *
 * This file contains the implementations of game action tools.
 * These tools should ONLY be imported from the lazy-loading wrapper (game-actions.ts),
 * not directly, to ensure Genkit is initialized first.
 */
