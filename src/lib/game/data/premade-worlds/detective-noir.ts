...
const items: GeneratedItem[] = [
    { name: 'Áo Khoác Trench', description: 'item_trench_coat_desc', emoji: '🧥', category: 'Equipment', tier: 2, effects: [], baseQuantity: { min: 1, max: 1 }, spawnBiomes: ['city'], equipmentSlot: 'armor', attributes: { cooldownReduction: 2 } },
