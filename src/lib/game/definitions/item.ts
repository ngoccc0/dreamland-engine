...
export const ItemDefinitionSchema = z.object({
  id: z.string().describe("Unique identifier for the item, e.g., 'healingHerb' or 'mod_naturePlus_magicRoot'"),
  name: MultilingualTextSchema.describe("The multilingual display name of the item."),
  description: MultilingualTextSchema.describe("The multilingual description of the item."),
  tier: z.number(),
