...
import type { Chunk, MoodTag, NarrativeLength, NarrativeTemplate, ConditionType, Language, PlayerStatus, World, ItemDefinition } from "@/core/types/game";
import { getTranslatedText, SmartJoinSentences, resolveItemId } from "@/lib/utils";
import { getTemplates } from '@/lib/game/templates';
import type { TranslationKey } from "@/lib/i18n";
import { logger } from "@/lib/logger";

import { isDay } from "@/lib/game/time/time-utils";// Import new time utilities
// clamp imported elsewhere when needed; not required here
import { biomeNarrativeTemplates, getKeywordVariations, selectRandom } from "@/lib/game/data/narrative-templates";
